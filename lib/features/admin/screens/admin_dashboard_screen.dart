...
class _AdminDashboardScreenState extends State<AdminDashboardScreen> {
  ...
  Future<void> _openDeliveryPricing() async {
    await _open(const DeliveryPricingScreen());
  }
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 5),
                Text('Manage restaurants, halal verification, delivery pricing and platform settings.', style: TextStyle(color: Colors.white70, fontSize: 13)),
              ],
            ),
          ),
        ],
  ...
  Widget _tools(bool wide) {
    final tools = [
      ...
      _AdminTool(Icons.delivery_dining_rounded, 'Delivery Pricing', 'Manage delivery fees, distance rates and surcharges.', Colors.blue, _openDeliveryPricing),
