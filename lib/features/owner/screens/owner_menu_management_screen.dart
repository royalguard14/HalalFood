                      ...
                      child: ListView.separated(
                        ...
                        itemBuilder: (_, index) {
                          ...
                          return ListTile(
                            ...
                            subtitle: Text(
                              '${_items.where((item) => item['category_id']?.toString() == category['id']?.toString()).length} item(s)',
                            ),
                            trailing: Wrap(
                              spacing: 0,
                              children: [
    ...
    return ListTile(
      ...
      title: Row(
        children: [
          ...
          if (bestSeller)
            _badge('BEST SELLER', Colors.orange),
          if (featured)
            _badge('FEATURED', HalalFoodTheme.primaryGreen),
        ],
      ),
      subtitle: Padding(
